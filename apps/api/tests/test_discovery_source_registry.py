...
def test_cli_adapter_plan_refuses_the_unreviewed_neura_module(shared_session, capsys):
    assert cli.main(["adapter", "plan", "neura-robotics-official"]) == cli.REFUSED
    out = capsys.readouterr().out
    assert "ADAPTER_NOT_STRUCTURALLY_REVIEWED" in out and "NOT RUNNABLE" in out
